...
<head>
  ...
  <title>Philly Ping Pong | P to 3</title>
...
<div class="wrapper" id="app">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    <!-- Left navbar links at top start -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./img/plogo.png" alt="Pto3 Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Philly Ping Pong</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/gallery" class="nav-link">
              <i class="nav-icon fas fa-camera-retro red"></i>
              <p>
                Gallery
              </p>
            </router-link>
          ...
          <li class="nav-item">
            <router-link to="/recordmatch" class="nav-link">
              <i class="nav-icon fas fa-hand-point-right indigo"></i>
              <p>
                Record Match
              </p>
            </router-link>
